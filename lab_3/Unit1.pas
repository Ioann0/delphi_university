...
uses
  ...
  VCLTee.Chart, Vcl.Samples.Spin, Vcl.ComCtrls, modul_3;
...
const n = 10;
      C: array[0..4] of string = ('линиям', 'лентами', 'точками', 'параллелепипедами', 'плоскостями');
var x, y: real;
    dx: real;
    i: integer;
    st: string;
begin
  Form1.Caption:= 'Рисование на Chart ' + C[NN];
  ...
  for i:= 1 to n do begin
    str(x:6:2, st);
    chart1[NN].AddXY(x, func_1(x), st, clTeeColor);
    chart1[NN+5].AddXY(x, 0.5 * func_1(x), st, clTeeColor);
    x:= x + dx;
  end;
end;
